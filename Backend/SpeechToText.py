...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when","why", "which", "whom", "can you", "what's", "where's", "how's", "can you"]

    # Check if query is a question and add a question mark if necesssary.
...
def SpeechRecognition():
    ...
    while True:
        try:
            # Get the recognized text from the HTML output elemnt.
...
if __name__ == "__main__":
    while True:
        # Continuously perform speech recognition and print teh recognized text.
