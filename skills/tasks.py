...
from skills import video_tools
...
def handle(text: str) -> str:
    ...
    # Background YouTube audio analysis
    if ("youtube" in t or "video" in t) and any(k in t for k in ["analyze", "analysis", "summarize", "summary", "describe", "background"]):
        return video_tools.start_background_youtube_audio_summary(text=text, brain=brain, stt=stt, jobs=jobs)

    return "Tasks module: mujhe is command ka task match nahi mila." 
